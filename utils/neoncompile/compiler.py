...
class Compiler:
  ...
  def compile_java(k, options, path):
    ...
    if not os.path.isfile(fullpath):
      ...
      src += '//Comparison - Greater than or equal to'
      ...
      src += '//Comparison - Less than or equal to'
      ...
      src += '//Comparison - Greater than'
      src += 'public int[] intGt(int[] a, int[] b);'
      src += 'public List<Integer> intGt(List<Integer> a, List<Integer> b);'
      src += 'public int[] floatGt(float[] a, float[] b);'
      src += 'public List<Integer> floatGt(List<Float> a, List<Float> b);'
      src += '//Comparison - Less than'
      src += 'public int[] intLt(int[] a, int[] b);'
      src += 'public List<Integer> intLt(List<Integer> a, List<Integer> b);'
      src += 'public int[] floatLt(float[] a, float[] b);'
      src += 'public List<Integer> floatLt(List<Float> a, List<Float> b);'
      src.unindent()
      src += '}'
